...
--
-- Extraindo dados da tabela `tb_tipo_reacao`
--

INSERT INTO `tb_tipo_reacao` (`id_tipo_reacao`, `descricao`, `dataInclusao`) VALUES
(1, 'CURTIR', '2021-11-20 20:53:21'),
...
--
ALTER TABLE `tb_tipo_reacao`
  MODIFY `id_tipo_reacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
